# Script para eliminar el arranque automático
...
# Eliminar script de inicio si existe
$startupScriptPath = Join-Path $PSScriptRoot "docker-autostart.ps1"
if (Test-Path $startupScriptPath) {
    Remove-Item $startupScriptPath -Force
    Write-Host "Script de inicio eliminado" -ForegroundColor Green
}
